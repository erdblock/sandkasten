    ...
    FileInput.prototype = {
        ...
        setThumbStatus: function ($thumb, status) {
            var self = this, icon = 'indicator' + status, msg = icon + 'Title',
                css = 'fileupload-' + status.toLowerCase(),
                $indicator = $thumb.find('.file-upload-indicator'),
                config = self.fileActionSettings;
            $thumb.removeClass('fileupload-success fileupload-error fileupload-loading');
        ...
        clearPreview: function () {
            var self = this, $thumbs = !self.showUploadedThumbs ? self.$preview.find('.file-preview-frame') :
                self.$preview.find('.file-preview-frame:not(.fileupload-success)');
            $thumbs.remove();
        },
        ...
        uploadSingle: function (i, files, allFiles) {
            ...
            fnBefore = function (jqXHR) {
                ...
                if (!$thumb.hasClass('fileupload-success')) {
